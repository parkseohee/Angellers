...
import uk.co.alt236.btlescan.activities.ImageViewCircle;
...
public class LeDeviceListAdapter extends SimpleCursorAdapter {
    ...
    public View getView(final int i, View view, final ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolder.deviceIcon = (uk.co.alt236.btlescan.activities.ImageViewCircle) view.findViewById(R.id.device_icon);
        ...
        if (BeaconUtils.getBeaconType(device) == BeaconType.IBEACON) {
           ...
           // ImageViewCircle ivc = (ImageViewCircle) view.findViewById(R.id.device_icon);
//            viewHolder.deviceIcon.setImageResource(R.drawable.ic_bluetooth);
            //viewHolder.deviceIcon.setImageDrawable(ivc);
            if(viewHolder.ibeaconSection != null) viewHolder.ibeaconSection.setVisibility(View.GONE);
        }
