...
public class DeviceDetailsActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CAMERA_REQUEST && resultCode == RESULT_OK) {
            ...
            mphoto = Bitmap.createBitmap(mphoto, 0, (int)mphoto.getWidth()/5, mphoto.getWidth(), mphoto.getWidth());
            mphoto = Bitmap.createScaledBitmap(mphoto, (int)(mUserImageView.getWidth()), mUserImageView.getHeight(), false);

            int padding = 3;
            mUserImageView.setPadding(padding, 0, padding, 0);

            mUserImageView.setImageBitmap(mphoto);
        }
    }
    ...
    private void appendDeviceInfo(final MergeAdapter adapter, final BluetoothLeDevice device) {
        ...
        final TextView userName = (TextView) lt.findViewById(R.id.username);
        ...
        mUserImageView = (ImageView) lt.findViewById(R.id.userimage);
